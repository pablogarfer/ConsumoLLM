...
#tracker = EmissionsTracker(project_name="GemmaX2", measure_power_secs=10, tracking_mode="process")
model_id = "ModelSpace/GemmaX2-28-2B-v0.1"
tokenizer = AutoTokenizer.from_pretrained(model_id)
num_parameters = 3_200_000_000  
experiment_name = "GemmaX2"

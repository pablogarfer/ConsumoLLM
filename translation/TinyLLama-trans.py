...
experiment_name = "TinyLLama_trans"
...
for i in range(30):
    ...
    messages = [
        {
            "role": "system",
            "content": "You are an excellent chatbot able to translate between different languages.",
        },
    ...
    translation = assistant_response.split("<|assistant|>")[1]
    print(translation)
    CC_tracker.stop()
    eco2ai_tracker.stop()
